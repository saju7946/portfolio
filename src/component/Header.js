    ...
    function Nav() {
        return (
            <>
                ...
                <NavLink className={({ isActive }) => `nnn py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 hover:text-[#099e66] md:border-b-2 border-transparent hover:text-text-[#099e66] focus:outline-none text-lg  ${isActive ? "text-[#099e66] border-[#099e66]" : "text-white"}`} to="/certificates">Certificates</NavLink>
