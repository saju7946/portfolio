    ...
    return (
        <>
            <div className="home_center absolute z-20 ">
                <h1 ref={motName} className=" text-[70px] font-bold mb-[34px] md:w-[560px] tracking-[5px]">Sajad Hussain Bhat</h1>
                <p ref={motLeft} className="text-center text-[25px] md:text-[30px] tracking-wide"> I'm a <span className=' text-[#099e66]'> <Typewriter
                    words={['Developer', 'Freelancer', 'Engineer']}
                    loop={false}
                    cursor
                    cursorStyle='|'
                    typeSpeed={100}
            ...
            <div className="absolute z-20 bottom-3 right-0 m-3 flex flex-col gap-5 ">
                ...
                <a  href="https://github.com/saju7946" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faGithub} className="nnn mx-2 text-xl hover_social  hover:text-[#009e66] relative " /></a>
                <a  href="https://www.linkedin.com/in/sajad-hussain-032801338" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faLinkedinIn} className="nnn mx-2 text-xl hover_social  hover:text-[#009e66]" /></a>
                 </div>
        </>
    );
}
